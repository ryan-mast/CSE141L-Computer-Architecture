...
public class coe_to_hex {
	...
	static class ProgParams {
		...
		ProgParams()
		{
			data_width_in_bits = 16; // default width is 16
	...
	static void parse_command_line_args(String[] args, ProgParams params) {
		for(int i = 0; i < args.length; ++i) {
			...
			// print out usage instructions
				...
				System.err.println("\nUsage: java coe_to_hex [options] <input.coe>");
				System.err.println("Options:");
				System.err.println("\t-w: Specify the data width (in bits). Default value is 16.");
				System.err.println("\t-r: Specify the radix of the input file numbers. Default value is 16 (hex).");
